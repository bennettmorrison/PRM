...
# require_relative 'concerns/GoogleContact'
# include GoogleContact

module GoogleContact 
  class << self 
    
  #specify the number of contacts you need
  MAX_RESULTS = 3000 
  CLIENT_ID = "687735713657-59u8dmqe68kihkqupvk6csgh1dp8uthb.apps.googleusercontent.com"
  
  #get and parse the contacts with your access token
  def GoogleContact.get
    url = "https://www.google.com/m8/feeds/contacts/default/full?max-results=#{MAX_RESULTS}"
    p url
